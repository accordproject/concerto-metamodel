...
function createNameTable(priorModels, metaModel) {
    ...
    const table = {
        ...
        'DateTimeMapKeyType': concertoNs,
        'BooleanMapValueType': concertoNs,
        'DateTimeMapValueType': concertoNs,
        'StringMapValueType': concertoNs,
        'IntegerMapValueType': concertoNs,
        'LongMapValueType': concertoNs,
        'DoubleMapValueType': concertoNs,
    };
